...
bot_token = os.environ.get("6629920564:AAFE5PeRLYmUXIsfEK60_Xpu95OpVhwPDYo", None) 
api_hash = os.environ.get("6f36129da1a6050ee10ece4fa99db6f0", None) 
api_id = os.environ.get("11727095", None)
bot = Client("mybot", api_id=api_id, api_hash=api_hash, bot_token=bot_token)

ss = os.environ.get("AQBgsBCpMX1VU1pqr4foB2ChdRU2eYIvm7kG8STHS9axAxILdNxYPNhsA12dJjykP-LMS-eQAVVdzYboA2hPIE2joqyAncyQhlcOjjRIkh5PhyPpDvSkNrQ_zHeGSXN_xEZJkzLmPVNwcLxeepPYLBjl5scbmzSSZNQhpn090txaviZmVRZY1j5AZrJao39HPSUZVddzVzdt3otobJW8QAu53pUm243RkvmO7MHEMQVUkLEOzyS4Jksvob4C-rY-rHu15NgwKIPzGW_gfTeCYrCHFGKCKrVBc__YxJ2Ph3hHz1YTO7l0MOlAOht58qjaj06QsFYrzWfy5d55DffGpeiDOKaB4QA", None)
if ss is not None:
